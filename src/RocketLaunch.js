  ...
  return (
    <div className={`body-state${currentState}`}>
      <div className="interface state1">
        <h1> Rocket Launch!</h1>
        <a href="#" className="buttons" onClick={() => changeState(2)}>Launch!</a>
      </div>
      ...
      <div className="interface state4">
        <h1>Well done!</h1>
        <a href="#" className="button" onClick={() => changeState(1)}>Do it again!</a>
      </div>

      <div className="interface state5">
        <h1>Oh No!!!!</h1>
        <a href="#" className="button" onClick={() => changeState(1)}>Try again!</a>
      </div>
